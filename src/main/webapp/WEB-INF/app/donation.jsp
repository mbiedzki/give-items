        ...
        <form:form method="post" modelAttribute="donation">
            ...
            <div data-step="1" class="active">
                ...
                <div class="form-group form-group--checkbox">
                    <form:select path="item">
                        <form:option value="0" label="--Wybierz rodzaj rzeczy--"/>
            ...
            <div data-step="2">
                ...
                <div class="form-group form-group--inline">
                    <label>
                        Liczba 60l worków:
                        <form:input path="numberOfBags" type="number" name="bags" step="1" min="1"/>
                    </label>
                </div>
            ...
            <!-- STEP 3 -->
            <div data-step="3">
                <h3>W jakiej lokalizacji chciałbyś pomóc?</h3>
